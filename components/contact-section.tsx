...
function ContactCard({
  ...
  return (
    <div
      className={`group relative overflow-hidden rounded-[18px] p-5 sm:p-6 ${glassBlur} transition-all duration-300 hover:-translate-y-1 hover:border-[var(--secondary)]/35 hover:shadow-[0_25px_55px_rgba(0,0,0,.38)]`}
      style={{ animationDelay: `${delay}ms` }}
    >
      <span className="pointer-events-none absolute left-3 top-3 h-4 w-4 border-l border-t border-transparent transition-all duration-300 group-hover:border-[var(--secondary-light)]/60" />
      <span className="pointer-events-none absolute bottom-3 right-3 h-4 w-4 border-b border-r border-transparent transition-all duration-300 group-hover:border-[var(--secondary-light)]/60" />

      <div className="mb-2.5 flex items-center gap-2 text-[10px] font-extrabold uppercase tracking-[0.18em] text-[var(--secondary)]">
        <span className="flex size-[26px] shrink-0 items-center justify-center rounded-full border border-[var(--glass-border)] bg-white/[0.045] text-[var(--secondary-light)]">
          {icon}
        </span>
        {label}
      </div>
...
export default function ContactSection() {
  ...
  // TEMPORARY UI TEST — remove before production
    ...
    >
      <div className="mx-auto w-full max-w-[1240px]">
        <header className="mb-8 sm:mb-9">
          ...
          >
            Let&apos;s Create{" "}
            <span className="inline-block whitespace-nowrap italic text-[var(--secondary-light)]">
              Something Beautiful
            </span>
          </h2>
        </header>
        ...
        <div className="grid items-start gap-6 lg:grid-cols-[minmax(300px,340px)_minmax(0,1fr)] lg:gap-10">
          <aside className="order-2 flex min-w-0 flex-col gap-4 lg:order-1">
            ...
            >
              <h3 className="mb-2 text-lg font-extrabold leading-[1.3] text-[var(--cream)]">
                Hyderabad, Telangana
              </h3>

              <p className="m-0 text-sm font-medium leading-[1.6] text-white/[0.62]">
                Roselanes by Jeev
                <br />
                By Appointment Only
              </p>
            ...
            >
              <a
                ...
                className="block break-words text-[15px] font-extrabold leading-[1.4] text-[var(--cream)] transition-colors hover:text-[var(--secondary-light)]"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              <ContactCard
                icon={<Phone className="size-[13px]" />}
                label="Phone"
                delay={160}
              >
                <a
                  href="tel:+919550044475"
                  className="block text-[14px] font-extrabold leading-[1.4] text-[var(--cream)] hover:text-[var(--secondary-light)]"
                >
                  Talk to Us
                </a>
              </ContactCard>
  ...
  >
    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.372-.025-.521-.075-.149-.669-1.611-.916-2.206-.242-.579-.487-.5-.669-.51-.173-.008-.372-.01-.57-.01-.198 0-.52.075-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.095 3.2 5.076 4.487.709.306 1.262.489 1.694.626.712.227 1.36.195 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982 1-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.986 2.894a9.825 9.825 0 012.893 6.994c-.002 5.45-4.437 9.883-9.885 9.883m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.89c0 2.096.547 4.142 1.588 5.945L.057 24l6.304-1.654a11.875 11.875 0 005.684 1.448h.005c6.554 0 11.89-5.335 11.893-11.89a11.84 11.84 0 00-3.479-8.416" />
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex min-h-[30px] items-center justify-center gap-2 text-white/[0.7] transition-colors hover:text-[var(--secondary-light)]"
            >
              ...
              <div className="flex h-5 items-center justify-center">
                <span className="text-[9px] font-extrabold uppercase leading-5 tracking-[0.12em] text-[var(--secondary)]">
                  Follow our stories
                </span>
              </div>
            ...
            <div className="flex items-center gap-3 px-3 py-3 text-xs font-medium leading-[1.4] text-white/[0.55]">
              ...
              >
                ...
                <div className="grid gap-4 sm:grid-cols-[2.5fr_1.5fr]">
                  ...
                  <Field label="Purpose" htmlFor="contact-purpose">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="enquiry">For Enquiry</SelectItem>
                ...
                {status && (
                  <p
                    ...
                    role="alert"
                    aria-live="polite"
                    className="m-0 text-sm text-red-300"
                  >
                    {status}
                  </p>
                )}
                ...
                <Button
                  type="submit"
                  disabled={submitting}
                  className="mt-1 min-h-[52px] w-auto max-w-full touch-manipulation self-center px-6 normal-case !text-[var(--primary-darkest)] [&_svg]:!text-[var(--primary-darkest)] lg:self-start lg:translate-x-4"
                >
...
<div className="w-[38%] max-w-[220px] shrink-0">
  <div className="flex aspect-square items-center justify-center rounded-full border border-[var(--secondary)]/25 bg-white/[0.03] w-[100%]">
    <img
      src="brand/icon.png"
    ...
    />
                ...
                <div className="flex min-w-0 flex-1 flex-col items-center gap-3 min-[700px]:items-start">
                  <h3 className="text-lg font-extrabold text-[var(--cream)]">
                  ...
                  <p className="m-0 text-xs text-white/[0.5]">
  ...
  <Button
    asChild
    className="!min-w-0 min-w-0 flex-1 !min-h-[46px] !px-3 normal-case !text-[clamp(0.62rem,1.15cqi,0.88rem)] !tracking-[0.06em]"
  >
    <a
      href="#portfolio"
